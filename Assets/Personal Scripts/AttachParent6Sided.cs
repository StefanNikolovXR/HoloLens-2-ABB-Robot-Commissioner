...
public class AttachParent6Sided : MonoBehaviour
{

    public GameObject ZoneCenter, Coordinate1, Coordinate2, Coordinate3, Coordinate4, Coordinate5, Coordinate6, CoordinateCenter;
    ...
    public void AttachtoSquare()
    {
        ...
        Coordinate6.transform.parent = CoordinateCenter.transform;
    }
    ...
    public void ResetParent()
    {
        ...
        Coordinate6.transform.parent = ZoneCenter.transform;
    }
