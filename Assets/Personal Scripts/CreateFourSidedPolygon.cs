...
public class CreateFourSidedPolygon : MonoBehaviour
{
    Mesh mesh;
    ...
    public GameObject ZoneCenter, Coordinate1, Coordinate2, Coordinate3, Coordinate4;
    ...
    void Awake()
    {
        ...
        vertices = new Vector3[] { new Vector3(x_Coordinate1, y_Coordinate1, z_Coordinate1), new Vector3(x_Coordinate2, y_Coordinate2, z_Coordinate2), new Vector3(x_Coordinate3, y_Coordinate3, z_Coordinate3), new Vector3(x_Coordinate4, y_Coordinate4, z_Coordinate4) };
        triangles = new int[] { 0, 1, 2, 0, 2, 3, 0, 3 };
