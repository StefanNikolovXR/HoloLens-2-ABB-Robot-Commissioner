...
public class TorqueRot1Left : MonoBehaviour
{
    ...
    public void PressTorqueRot1LeftOnce()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
        input.JogJ1SingleTimeNeg();
    }

    public void HoldTorqueRot1Left()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
    ...
    public void StopHoldingRot1Left()
    {
