...
public class Centroid6Sided : MonoBehaviour
{
    public GameObject p1, p2, p3, p4, p5, p6, CenteredObjectLower, CenteredObjectUpper, ZoneCenter;
    private float p1x, p1z, p2x, p2z, p3x, p3z, p4x, p4z, p5x, p5z, p6x, p6z, paveragex, paveragez, centeredylower, centeredyupper;
    ...
    void Awake()
    {
        ...
        p6z = p6.transform.position.z;

        paveragex = (p1x + p2x + p3x + p4x + p5x + p6x) / 6;
        paveragez = (p1z + p2z + p3z + p4z + p5z + p6z) / 6;
