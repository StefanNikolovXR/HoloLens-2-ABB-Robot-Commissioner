...
public class GetTool : MonoBehaviour
{
    ...
    public TextMeshProUGUI Xx, Xy, Xz, Zx, Zy, Zz;
    public TextMeshPro rsX, rsY, rsZ;
    public CreateCone globalcone;
    public CreateCone storedcone;
    ...
    public void CreateConeAtTool()
    {
            ...
            globalcone.CreateConeAtTool();

        storedcone = globalcone;
