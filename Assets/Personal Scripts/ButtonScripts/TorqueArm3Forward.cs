...
public class TorqueArm3Forward : MonoBehaviour
{
    ...
    public void PressTorqueArm3ForwardOnce()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
        input.JogJ3SingleTime();
    }

    public void HoldTorqueArm3Forward()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
    ...
    public void StopHoldingArm3Forward()
    {
