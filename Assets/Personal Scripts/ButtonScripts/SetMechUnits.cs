...
public class SetMechUnits : MonoBehaviour
{
    ...
    public InputfromUnitytoRS inputrs;
    ...
    public void ToggleSetMechUnits()
    {
        if (istoggled)
        {
        ...
        else
        {
            ...
            inputrs.solveron = true;
            inputrs.SyncMechanicalUnits();
        }
    }
