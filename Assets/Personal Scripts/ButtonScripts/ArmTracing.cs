...
public class ArmTracing : MonoBehaviour
{
    ...
    public CalculateProjectionDistance projectionscript;
    ...
    public void ArmTracingToggle()
    {
        if (istoggled)
        {
            ...
            projectionscript.ArmTracingOFF();
        }
