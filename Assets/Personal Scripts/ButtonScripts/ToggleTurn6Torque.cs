...
public class ToggleTurn6Torque : MonoBehaviour
{
    ...
    public ToggleSpeed ToggleSpeed;
    ...
    public void ToggleTurn6Press()
    {
        ...
        else
        {
            ...
            ToggleWrist4Torque.ForceCollapse();
            ToggleBend5Torque.ForceCollapse();
            //ToggleTurn6.ForceCollapse();
            ToggleSpeed.ForceCollapse();

            torqueslider.sliderstatus = 6;
            torqueslider.SetupSlider();
        }
    }
