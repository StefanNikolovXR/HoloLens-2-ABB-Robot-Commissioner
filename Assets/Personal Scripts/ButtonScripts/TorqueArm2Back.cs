...
public class TorqueArm2Back : MonoBehaviour
{
    ...
    public void PressTorqueArm2BackOnce()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
        input.JogJ2SingleTimeNeg();
    }

    public void HoldTorqueArm2Back()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
    ...
    public void StopHoldingArm2Back()
    {
