...
public class SpeedRight : MonoBehaviour
{
    ...
    public void MoveSpeedRight()
    {
        instructions.ShiftSpeedRight();
    }

    public void HoldSpeedRight() { 
        InvokeRepeating("MoveSpeedRight", 0.75f, 0.75f);
    }
