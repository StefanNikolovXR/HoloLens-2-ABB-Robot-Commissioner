...
public class ToggleGeneral : MonoBehaviour
{
    ...
    public LeanEvent disappear, zonetools_appear, globaltools_appear;
    ...
    public void ToggleGeneralTable()
    {
        ...
        else
        {
            ...
            if (buttonname.text == "Global Tools")
            {
                ...
                globaltools_appear.BeginThisTransition();
            ...
            else if (buttonname.text == "Zone Tools")
            {
                zonetools_appear.BeginThisTransition();
