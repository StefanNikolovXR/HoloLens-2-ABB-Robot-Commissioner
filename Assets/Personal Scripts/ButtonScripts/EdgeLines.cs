...
public class EdgeLines : MonoBehaviour
{
    ...
    private GameObject Coordinates_Container, TopCoordinates_Container;
    ...
    public void ToggleEdgeLines()
    {
        if (istoggled)
        {
            ...
            {
                var childxyz = child.transform.Find("Line").gameObject;
                childxyz.GetComponent<MeasureLine>().enabled = false;
            }

            foreach (Transform child in Coordinates_Container.transform)
            {
                var childxyz = child.transform.Find("Line_Vertical").gameObject;
                childxyz.GetComponent<MeasureLine>().enabled = false;
            }
            ...
            values.selectedzone.transform.Find("Stored_Data").gameObject.GetComponent<SafeZoneStoredData>().lines = false;
        }
        ...
        else
        {
            ...
            {
                var childxyz = child.transform.Find("Line").gameObject;
                childxyz.GetComponent<MeasureLine>().enabled = true;
            }
            ...
            values.selectedzone.transform.Find("Stored_Data").gameObject.GetComponent<SafeZoneStoredData>().lines = true;
        }
    }

    public void CollapseEdgeLines() {
        Coordinates_Container = values.selectedzone.transform.Find("Coordinates_Container").gameObject;
        TopCoordinates_Container = values.selectedzone.transform.Find("TopCoordinates_Container").gameObject;
