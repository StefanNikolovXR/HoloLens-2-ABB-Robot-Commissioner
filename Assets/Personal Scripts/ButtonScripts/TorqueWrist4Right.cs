...
public class TorqueWrist4Right : MonoBehaviour
{
    ...
    public void PressTorqueWrist4RightOnce()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
        input.JogJ4SingleTime();
    }

    public void HoldTorqueWrist4Right()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
    ...
    public void StopHoldingWrist4Right()
    {
