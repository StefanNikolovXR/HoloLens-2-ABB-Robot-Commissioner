...
public class MainMenu : MonoBehaviour
{
    ...
    public LeanEvent collapseallmenus;

    public General general;
    public Robot robot;
    public EnvironmentButton environment;
    public IKPathing ikpathing;
    ...
    public LeanEvent general1, robot1, environment1, ikpathing1, connection1, assistant1, safezones1, masterslider1, replay1, accessibility1, fortesting1;
        ...
        if (!isheld)
        {
            if (istoggled)
            {
               ...
               // CheckMenus();
                ...
                collapseallmenus.BeginAllTransitions();
    ...
    {
        general.ForceCollapse();
        robot.ForceCollapse();
        environment.ForceCollapse();
        ikpathing.ForceCollapse();
        connection.ForceCollapse();
        assistant.ForceCollapse();
        safezones.ForceCollapse();
        masterslider.ForceCollapse();
        replay.ForceCollapse();
        accessibility.ForceCollapse();
        fortesting.ForceCollapse();
    }
