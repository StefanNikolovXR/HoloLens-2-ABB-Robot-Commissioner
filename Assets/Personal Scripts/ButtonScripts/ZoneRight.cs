...
public class ZoneRight : MonoBehaviour
{
    ...
    public void MoveZoneRight()
    {
        instructions.ShiftZoneRight();
    }

    public void HoldZoneRight()
    {
        InvokeRepeating("MoveZoneRight", 0.75f, 0.75f);
    }
