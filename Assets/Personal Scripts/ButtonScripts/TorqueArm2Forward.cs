...
public class TorqueArm2Forward : MonoBehaviour
{
    ...
    public void PressTorqueArm2ForwardOnce()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
        input.JogJ2SingleTime();
    }

    public void HoldTorqueArm2Forward()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
    ...
    public void StopHoldingArm2Forward()
    {
