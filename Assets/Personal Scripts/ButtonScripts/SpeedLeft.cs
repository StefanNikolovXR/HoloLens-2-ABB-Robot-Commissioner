...
public class SpeedLeft : MonoBehaviour
{
    ...
    public void MoveSpeedLeft()
    {
        instructions.ShiftSpeedLeft();
    }

    public void HoldSpeedLeft()
    {
        InvokeRepeating("MoveSpeedLeft", 0.75f, 0.75f);
    }
