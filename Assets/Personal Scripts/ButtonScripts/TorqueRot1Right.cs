...
public class TorqueRot1Right : MonoBehaviour
{
    ...
    public void PressTorqueRot1RightOnce()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
        input.JogJ1SingleTime();
    }

    public void HoldTorqueRot1Right()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
    ...
    public void StopHoldingRot1Right()
    {
