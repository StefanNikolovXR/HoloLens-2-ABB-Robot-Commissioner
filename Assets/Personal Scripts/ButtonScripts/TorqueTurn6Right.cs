...
public class TorqueTurn6Right : MonoBehaviour
{
    ...
    public void PressTorqueTurn6RightOnce()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
        input.JogJ6SingleTime();
    }

    public void HoldTorqueTurn6Right()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
    ...
    public void StopHoldingTurn6Right()
    {
