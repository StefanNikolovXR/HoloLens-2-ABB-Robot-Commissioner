...
public class TutorialMode : MonoBehaviour
{
    ...
    public FocusAssistMode focusmode;
    ...
    public void ToggleTutorialMode()
    {
        if (istoggled)
        {
            ...
            lunarcomcontroller.outputbox.ToolTipText = "I'm now in the default Focus Assist Mode. When you hover over holograms in your environment, I will give you helpful information regarding them!";
        ...
        else
        {
            ...
            focusmode.ForceCollapse();
            //tutorial.ForceCollapse();

            //the button's functionality
            lunarcom.speechRecognitionMode = RecognitionMode.Intent_Recognizer;
            lunarcom.ToggleSelected();
            lunarcomcontroller.outputbox.ToolTipText = "I am now in Command Mode. Tap on me and say what action I should take. Some actions require you to hover over a hologram for me to understand them. You can ask me to give you a complete list of all commands I accept.";
        }
    }
