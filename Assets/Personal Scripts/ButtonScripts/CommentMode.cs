...
public class CommentMode : MonoBehaviour
{
    ...
    public LunarcomSpeechRecognizer lunarcomspeech;
   ...
   // public CommentMode comment;
    ...
    public LUISFocusAssist luisfocus;
    ...
    public void ToggleCommentMode()
    {
        if (istoggled)
        {
            ...
            lunarcomcontroller.outputbox.ToolTipText = "I am no longer in Comment mode. Please select what active mode you would like me to be in!";
        ...
        else
        {
            ...
            //the button's functionality
            lunarcomspeech.CreateSpeechRecognizer();
            lunarcom.speechRecognitionMode = RecognitionMode.Speech_Recognizer;
            ...
            lunarcomcontroller.outputbox.ToolTipText = "I am now in Comment Mode. Tap on me to start recording your comment. When you finish speaking, I will create a new comment for you to place in your environment!";
        }
    }
