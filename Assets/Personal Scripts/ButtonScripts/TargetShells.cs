...
public class TargetShells : MonoBehaviour
{
    ...
    public void ToggleTargetShells()
    {
        if (istoggled)
        {
           ...
           foreach (Transform child in container.transform)
            {
                var shell = child.transform.Find("Target_Shell").gameObject;
        ...
        else
        {
            ...
            {
                var shell = child.transform.Find("Target_Shell").gameObject;
                shell.GetComponent<MeshRenderer>().enabled = true;
