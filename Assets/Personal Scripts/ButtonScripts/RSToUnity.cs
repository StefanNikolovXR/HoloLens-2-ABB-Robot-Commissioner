...
public class RSToUnity : MonoBehaviour
{
    ...
    public irb120_link1 j1link;
    public irb120_link2 j2link;
    public irb120_link3 j3link;
    public irb120_link4 j4link;
    public irb120_link5 j5link;
    public irb120_link6 j6link;
    ...
    public void ToggleRSToUnity()
    {
        if (istoggled)
        {
            ...
            j1link.enabled = false;
            j2link.enabled = false;
            j3link.enabled = false;
            j4link.enabled = false;
            j5link.enabled = false;
            j6link.enabled = false;
        }
