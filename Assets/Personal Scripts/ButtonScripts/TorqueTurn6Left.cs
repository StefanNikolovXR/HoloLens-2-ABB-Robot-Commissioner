...
public class TorqueTurn6Left : MonoBehaviour
{
    ...
    public void PressTorqueTurn6LeftOnce()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
        input.JogJ6SingleTimeNeg();
    }

    public void HoldTorqueTurn6Left()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
    ...
    public void StopHoldingTurn6Left()
    {
