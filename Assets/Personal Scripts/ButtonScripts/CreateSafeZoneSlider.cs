...
public class CreateSafeZoneSlider : MonoBehaviour
{
    ...
    public GameObject axisslider, replayslider, createslider, torqueslider;
    ...
    public void ToggleCreateSafeZone()
    {
        if (istoggled)
        {
            ...
            axisslider.SetActive(false);
            createslider.SetActive(false);
            replayslider.SetActive(false);
            torqueslider.SetActive(false);
        }
