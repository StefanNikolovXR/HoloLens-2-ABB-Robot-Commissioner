...
public class TorqueArm3Back : MonoBehaviour
{
    ...
    public void PressTorqueArm3BackOnce()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
        input.JogJ3SingleTimeNeg();
    }

    public void HoldTorqueArm3Back()
    {
        ButtonParent.GetComponent<AudioSource>().PlayOneShot(togglesoundon);
    ...
    public void StopHoldingArm3Back()
    {
