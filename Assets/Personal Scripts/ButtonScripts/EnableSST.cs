...
public class EnableSST : MonoBehaviour
{
    ...
    public void ToggleEnableSST()
    {
        if (istoggled)
        {
            ...
            values.DataChanged();
                ...
                //var zonevalues = values.selectedzone.transform.Find("ZoneValues");
                // zonevalues.GetComponent<ZoneValues>().
