...
public class AxisPosition : MonoBehaviour
{
    ...
    public GameObject SafeMoveSliderData_Container;
    ...
    public void ButtonFunctiontoReplace()
    {
        if (istoggled)
        {
           ...
           // SafeMoveSliderData_Container.GetComponent<SafeMoveSliderData>().axisposition = false;
        }
        ...
        else
        {
            ...
            //the button's functionality
          //  SafeMoveSliderData_Container.GetComponent<SafeMoveSliderData>().axisposition = true;
