...
public class TemplateLeft : MonoBehaviour
{
    ...
    public void MoveTemplateLeft()
    {
            instructions.ShiftTemplateLeft();
    }

    public void HoldTemplateLeft()
    {
        InvokeRepeating("MoveTemplateLeft", 0.75f, 0.75f);
    }

    public void StopHoldingLeft()
    {
        CancelInvoke();
    }
