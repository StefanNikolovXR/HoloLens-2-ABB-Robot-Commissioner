...
public class IKPathing : MonoBehaviour
{
    ...
    public IKSolvertoToolPOS iktotool;
    public GameObject Base, IKHandle;
    public bool activeSelf;
    public LockBoneWeight lockbones;
    ...
    public void ToggleIKPathing()
    {
        ...
        if (!isheld)
        {
            if (istoggled)
            {
                ...
                lockbones.HideAllAxes();
                lockbones.axislocking = false;
            }
            ...
            else
            {
                ...
                iktotool.MatchCoordinates();
                Base.GetComponent<CCDIK>().enabled = true;

                //the button's toggled ON functionality
                lockbones.UnlockAllAxes();
                lockbones.axislocking = true;
