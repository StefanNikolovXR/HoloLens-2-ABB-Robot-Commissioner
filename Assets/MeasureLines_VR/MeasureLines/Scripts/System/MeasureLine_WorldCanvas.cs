...
//		//Text
//		if (AxisX_N && showL && InFrontOfCamera (nearPoint_L)) {
//			uiText_L.text = NumberToPlaceString (lengthL, decimalPlaces);
//			wCanvas_L.transform.position = nearPoint_L;
//			wCanvas_L.transform.rotation = camTransform.rotation;
//			wCanvas_L.transform.localScale = Vector3.one * 0.04f * canvasScale;
...
//		}
//
//		if (AxisX_P && showR && InFrontOfCamera(nearPoint_R)) {
//			uiText_R.text = NumberToPlaceString (lengthR, decimalPlaces);
//			wCanvas_R.transform.position = nearPoint_R;
//			wCanvas_R.transform.rotation = camTransform.rotation;
//			wCanvas_R.transform.localScale = Vector3.one * 0.04f * canvasScale;
...
//		}
//
//		if (AxisY_P && showU && InFrontOfCamera(nearPoint_U)) {
//			uiText_U.text = NumberToPlaceString (lengthU, decimalPlaces);
//			wCanvas_U.transform.position = nearPoint_U;
//			wCanvas_U.transform.rotation = camTransform.rotation;
//			wCanvas_U.transform.localScale = Vector3.one * 0.04f * canvasScale;
...
//		}
//
//		if (AxisY_N && showD && InFrontOfCamera(nearPoint_D)) {
//			uiText_D.text = NumberToPlaceString (lengthD, decimalPlaces);
//			wCanvas_D.transform.position = nearPoint_D;
//			wCanvas_D.transform.rotation = camTransform.rotation;
//			wCanvas_D.transform.localScale = Vector3.one * 0.04f * canvasScale;
...
//		}
//
//		if (AxisZ_P && showF && InFrontOfCamera(nearPoint_F)) {
//			uiText_F.text = NumberToPlaceString (lengthF, decimalPlaces);
//			wCanvas_F.transform.position = nearPoint_F;
//			wCanvas_F.transform.rotation = camTransform.rotation;
//			wCanvas_F.transform.localScale = Vector3.one * 0.04f * canvasScale;
...
//		}
//
//		if (AxisZ_N && showB && InFrontOfCamera(nearPoint_B)) {
//			uiText_B.text = NumberToPlaceString (lengthB, decimalPlaces);
//			wCanvas_B.transform.position = nearPoint_B;
//			wCanvas_B.transform.rotation = camTransform.rotation;
//			wCanvas_B.transform.localScale = Vector3.one * 0.04f * canvasScale;
...
//		GUI.color = textColor;
//		if (AxisX_P && showR && InFrontOfCamera(line_R.transform.position)) {
//			screenR = mainCamera.WorldToScreenPoint (line_R.transform.position);
//			GUI.Label (new Rect (screenR.x-textBiasX, Screen.height - screenR.y, 150, 50), (Mathf.Round (lengthR * 100) / 100).ToString () + "m");
//		}
//		if (AxisX_N && showL && InFrontOfCamera(line_L.transform.position)) {
//			screenL = mainCamera.WorldToScreenPoint (line_L.transform.position);
//			GUI.Label (new Rect (screenL.x-textBiasX, Screen.height - screenL.y, 150, 50), (Mathf.Round (lengthL * 100) / 100).ToString () + "m");
//		}
//		if (AxisY_P && showU && InFrontOfCamera(line_U.transform.position)) {
//			screenU = mainCamera.WorldToScreenPoint (line_U.transform.position);
//			GUI.Label (new Rect (screenU.x-textBiasX, Screen.height - screenU.y, 150, 50), (Mathf.Round (lengthU * 100) / 100).ToString () + "m");
//		}
//		if (AxisY_N && showD && InFrontOfCamera(line_D.transform.position)) {
//			screenD = mainCamera.WorldToScreenPoint (line_D.transform.position);
//			GUI.Label (new Rect (screenD.x-textBiasX, Screen.height - screenD.y, 150, 50), (Mathf.Round (lengthD * 100) / 100).ToString () + "m");
//		}
//		if (AxisZ_P && showF && InFrontOfCamera(line_F.transform.position)) {
//			screenF = mainCamera.WorldToScreenPoint (line_F.transform.position);
//			GUI.Label (new Rect (screenF.x-textBiasX, Screen.height - screenF.y, 150, 50), (Mathf.Round(lengthF*100)/100).ToString()+"m");
//		}
//		if (AxisZ_N && showB && InFrontOfCamera(line_B.transform.position)) {
//			screenB = mainCamera.WorldToScreenPoint (line_B.transform.position);
