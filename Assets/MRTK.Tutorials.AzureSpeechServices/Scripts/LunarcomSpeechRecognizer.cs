    ...
    public async void BeginRecognizing()
    {
        if (micPermissionGranted)
        {
            ...
            if (recognizer != null)
            {
                ...
                recognizedString = "I am now in Comment Mode! Please pronounce your comment clearly and when it's ready, tap on me and I will create a comment box for you to place in your environment.";
            }
        }
        else
        {
