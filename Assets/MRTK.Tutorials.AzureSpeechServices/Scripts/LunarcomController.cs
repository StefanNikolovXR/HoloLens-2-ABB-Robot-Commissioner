...
public class LunarcomController : MonoBehaviour
{
    ...
    public void SelectMode(RecognitionMode speechRecognitionModeToSet)
    {
        ...
        {
            if (outputbox.ToolTipText == $"You can speak now and I will display your comment!" || outputbox.ToolTipText == $"")
            {
                outputbox.ToolTipText = $"You can speak now and I will display your comment!";
            }
        }
    }
    ...
    public void HideTerminal()
    {
        if (terminal.activeSelf)
        {
            ...
            outputbox.ToolTipText = $"Select a mode to begin.";
    ...
    {
       outputbox.ToolTipText = textToUpdate;
    }
}
