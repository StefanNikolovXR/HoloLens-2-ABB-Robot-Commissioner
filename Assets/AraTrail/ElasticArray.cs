...
{
    /**
	 * Custom IList implementation that allows access to the underlying raw array. This enables several tricks
     * that aren't possible with List<T>, such as passing a reference to the contents of an entry to a function.
	 */
    public class ElasticArray<T> : IList<T>
    {
