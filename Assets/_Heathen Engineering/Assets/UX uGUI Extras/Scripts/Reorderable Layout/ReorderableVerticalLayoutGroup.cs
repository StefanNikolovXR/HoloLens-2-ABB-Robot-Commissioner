...
{
    [AddComponentMenu("UX/Reorderable Layout Group/Reorderable (Vertical)")]
    [RequireComponent(typeof(UnityEngine.UI.VerticalLayoutGroup))]
    public class ReorderableVerticalLayoutGroup : HeathenUIBehaviour, ICollection<RectTransform>
    {
